...
const newAttributes = [
    {
        name: "Χρώμα",
        visible: true,
        options: ["Ασημί και χρυσό χρώμα"]
    },
    {
        name: "Διαστάσεις",
        visible: true,
        options: ["Συνολικό μήκος 2,5 εκ."]
    }
];

updateProductAttributes(211, newAttributes).then(product => {
    console.log("Product 211 updated with color!");
