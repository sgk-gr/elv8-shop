            ...
            <main className="container mx-auto px-2 sm:px-4 pt-24 md:pt-28 pb-16 min-h-[85vh] flex flex-col">
                <div className="flex items-center justify-between mb-4 px-2">
                    <button
                        ...
                        className="inline-flex items-center gap-1.5 font-body text-xs sm:text-sm font-bold text-slate-600 hover:text-[#FF1D8E] transition-colors bg-slate-100/80 px-4 py-2 rounded-full shadow-2xs"
                    >
                        <ChevronLeft className="w-4 h-4" />
                        Πίσω στο Καλάθι
                    </button>
