...
export default function AndrikaDaxtilidiaPage() {
    // Φέρνουμε τα προϊόντα για την κατηγορία Ανδρικά Δαχτυλίδια (ID: 26)
    const { data: products = [], isLoading } = useQuery<WooProduct[]>({
        queryKey: ["products", { category: "26" }],
        queryFn: () => getProducts({ per_page: "100", category: "26" }),
    });
        ...
        <main className="container mx-auto px-4 md:px-8 py-12 md:py-20">
            ...
            <div className="space-y-4 mb-12">
                ...
                <p className="text-muted-foreground font-body max-w-2xl leading-relaxed">
                    Ανακαλύψτε τη συλλογή μας από ανδρικά δαχτυλίδια. 
                    Μοναδικά σχέδια που προσδίδουν δυναμισμό και ιδιαίτερο στυλ σε κάθε εμφάνιση.
                </p>
