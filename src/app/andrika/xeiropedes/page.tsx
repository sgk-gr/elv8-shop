...
export default function AndrikaXeiropedesPage() {
    // Φέρνουμε τα προϊόντα για την κατηγορία Χειροπέδες (ID: 28)
    const { data: products = [], isLoading } = useQuery<WooProduct[]>({
        queryKey: ["products", { category: "28" }],
        queryFn: () => getProducts({ per_page: "100", category: "28" }),
    });
    ...
    return (
        <main className="container mx-auto px-4 md:px-8 py-12 md:py-20">
            ...
            <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
                ...
                <ChevronRight className="w-4 h-4" />
                <span className="text-primary font-medium">Χειροπέδες</span>
            </nav>
            ...
            <div className="space-y-4 mb-12">
                ...
                <p className="text-muted-foreground font-body max-w-2xl leading-relaxed">
                    Ανακαλύψτε τη συλλογή μας από ανδρικές χειροπέδες. 
                    Μοναδικά κοσμήματα που προσδίδουν διακριτική αλλά δυναμική πινελιά στο καθημερινό σας στυλ.
                </p>
