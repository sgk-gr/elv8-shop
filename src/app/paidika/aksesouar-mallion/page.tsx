...
export default function PaidikaAksesouarMallionPage() {
    // Φέρνουμε τα προϊόντα για την κατηγορία Παιδικά -> Αξεσουάρ Μαλλιών (ID: 93)
    const { data: products = [], isLoading } = useQuery<WooProduct[]>({
        queryKey: ["products", { category: "93" }],
        queryFn: () => getProducts({ per_page: "100", category: "93" }),
    });
        ...
        <main className="container mx-auto px-4 md:px-8 py-12 md:py-20">
            ...
            <div className="space-y-4 mb-12">
                <h1 className="font-display text-4xl md:text-5xl font-bold tracking-tight text-[#C4196D]">
                    Παιδικά Αξεσουάρ Μαλλιών
                </h1>
                <p className="text-muted-foreground font-body max-w-2xl leading-relaxed">
                    Ανακαλύψτε την υπέροχη συλλογή μας από παιδικά αξεσουάρ μαλλιών. 
                    Κουτάκια, κλιπ και στέκες που θα χαρίσουν λάμψη και στυλ στις μικρές μας φίλες.
                </p>
