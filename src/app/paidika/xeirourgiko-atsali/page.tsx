...
export default function PaidikaXeirourgikoAtsaliPage() {
    // Φέρνουμε τα προϊόντα για την κατηγορία Παιδικά -> Χειρουργικό Ατσάλι (ID: 31)
    const { data: products = [], isLoading } = useQuery<WooProduct[]>({
        queryKey: ["products", { category: "31" }],
        queryFn: () => getProducts({ per_page: "100", category: "31" }),
    });
    ...
    return (
        <main className="container mx-auto px-4 md:px-8 py-12 md:py-20">
            ...
            <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
                ...
                <ChevronRight className="w-4 h-4" />
                <span className="text-primary font-medium">Χειρουργικό Ατσάλι</span>
            </nav>

            <div className="space-y-4 mb-12">
                <h1 className="font-display text-4xl md:text-5xl font-bold tracking-tight text-[#C4196D]">
                    Παιδικά Κοσμήματα από Χειρουργικό Ατσάλι
                </h1>
                <p className="text-muted-foreground font-body max-w-2xl leading-relaxed">
                    Ανακαλύψτε τη συλλογή μας από παιδικά κοσμήματα από χειρουργικό ατσάλι. 
                    Ανθεκτικά και υποαλλεργικά, φτιαγμένα με αγάπη και φροντίδα για την παιδική επιδερμίδα.
                </p>
