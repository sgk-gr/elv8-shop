...
export default function RoloiXeirosPage() {
    // Φέρνουμε τα προϊόντα για την κατηγορία Ρολόι χειρός (ID: 95)
    const { data: products = [], isLoading } = useQuery<WooProduct[]>({
        queryKey: ["products", { category: "95" }],
        queryFn: () => getProducts({ per_page: "100", category: "95" }),
    });
        ...
        <main className="container mx-auto px-4 md:px-8 py-12 md:py-20">
            ...
            <div className="space-y-4 mb-12">
                ...
                <p className="text-muted-foreground font-body max-w-2xl leading-relaxed">
                    Ανακαλύψτε την εκλεπτυσμένη συλλογή μας από ρολόγια χειρός. 
                    Σχέδια που συνδυάζουν την κομψότητα με την πρακτικότητα, ιδανικά για να αναδείξουν κάθε σας εμφάνιση.
                </p>
