...
export default function KolieAsimenia925Page() {
    // Φέρνουμε τα προϊόντα για την κατηγορία Ασημένια 925 (ID: 107)
    const { data: products = [], isLoading } = useQuery<WooProduct[]>({
        queryKey: ["products", { category: "107" }],
        queryFn: () => getProducts({ per_page: "100", category: "107" }),
    });
    ...
    return (
        <main className="container mx-auto px-4 md:px-8 py-12 md:py-20">
            ...
            <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
                ...
                <ChevronRight className="w-4 h-4" />
                <span className="text-primary font-medium">Ασημένια 925</span>
            </nav>
            ...
            <div className="space-y-4 mb-12">
                ...
                <p className="text-muted-foreground font-body max-w-2xl leading-relaxed">
                    Ανακαλύψτε τη συλλογή μας από πανέμορφα κολιέ από ασήμι 925. 
                    Κομψά και διαχρονικά σχέδια που αναδεικνύουν τη θηλυκότητα και προσθέτουν μια λάμψη πολυτέλειας σε κάθε σας στιγμή.
                </p>
