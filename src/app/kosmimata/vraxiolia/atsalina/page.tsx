...
export default function AtsalinaBraceletsPage() {
    // Φέρνουμε τα προϊόντα για την κατηγορία ατσάλινα 
    const { data: products = [], isLoading } = useQuery<WooProduct[]>({
        queryKey: ["products", { category: "23" }],
        queryFn: () => getProducts({ per_page: "100", category: "23" }),
    });
        ...
        <main className="container mx-auto px-4 md:px-8 py-12 md:py-20">
            ...
            <div className="space-y-4 mb-12">
                ...
                <p className="text-muted-foreground font-body max-w-2xl leading-relaxed">
                    Ανακαλύψτε τη συλλογή μας από κομψά και ανθεκτικά ατσάλινα βραχιόλια. 
                    Σχεδιασμένα για να αντέχουν στο χρόνο και να αναδεικνύουν το στυλ σας σε κάθε περίσταση.
                </p>
