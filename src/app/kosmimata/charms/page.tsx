...
export default function CharmsPage() {
    // Φέρνουμε τα προϊόντα για την κατηγορία Charms (ID: 112) και The Charm bar (ID: 121)
    const { data: products = [], isLoading } = useQuery<WooProduct[]>({
        queryKey: ["products", { category: "112,121" }],
        queryFn: () => getProducts({ per_page: "100", category: "112,121" }),
    });
    ...
    return (
        <main className="container mx-auto px-4 md:px-8 py-12 md:py-20">
            ...
            <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
                ...
                <ChevronRight className="w-4 h-4" />
                <span className="text-primary font-medium">Charms</span>
            </nav>
            ...
            <div className="space-y-4 mb-12">
                ...
                <p className="text-muted-foreground font-body max-w-2xl leading-relaxed">
                    Ανακαλύψτε τη μοναδική συλλογή μας από Charms. Διαλέξτε τα αγαπημένα σας
                    και δημιουργήστε το δικό σας μοναδικό στυλ με κάθε κομμάτι.
                </p>
