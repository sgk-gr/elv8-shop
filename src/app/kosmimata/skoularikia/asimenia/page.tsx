...
export default function SkoularikiaAsimeniaPage() {
    // Φέρνουμε τα προϊόντα για την κατηγορία Ασημένια (ID: 97) κάτω από τα Σκουλαρίκια
    const { data: products = [], isLoading } = useQuery<WooProduct[]>({
        queryKey: ["products", { category: "97" }],
        queryFn: () => getProducts({ per_page: "100", category: "97" }),
    });
        ...
        <main className="container mx-auto px-4 md:px-8 py-12 md:py-20">
            ...
            <div className="space-y-4 mb-12">
                <h1 className="font-display text-4xl md:text-5xl font-bold tracking-tight text-[#C4196D]">
                    Σκουλαρίκια Ασημένια
                </h1>
                <p className="text-muted-foreground font-body max-w-2xl leading-relaxed">
                    Ανακαλύψτε τη συλλογή μας από κομψά ασημένια σκουλαρίκια. 
                    Διαχρονικά σχέδια από ασήμι υψηλής ποιότητας, ιδανικά για να προσδώσουν μια διακριτική πολυτέλεια σε κάθε σας εμφάνιση.
                </p>
