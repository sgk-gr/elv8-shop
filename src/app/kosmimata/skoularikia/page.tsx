...
export default function SkoularikiaPage() {
    // Φέρνουμε τα προϊόντα για την κατηγορία Σκουλαρίκια (ID: 19)
    const { data: products = [], isLoading } = useQuery<WooProduct[]>({
        queryKey: ["products", { category: "19" }],
        queryFn: () => getProducts({ per_page: "100", category: "19" }),
    });
    ...
    return (
        <main className="container mx-auto px-4 md:px-8 py-12 md:py-20">
            ...
            <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
                ...
                <span className="hover:text-primary transition-colors cursor-pointer">Κοσμήματα</span>
                <ChevronRight className="w-4 h-4" />
                <span className="text-primary font-medium">Σκουλαρίκια</span>
            </nav>
            ...
            <div className="space-y-4 mb-12">
                ...
                <p className="text-muted-foreground font-body max-w-2xl leading-relaxed">
                    Ανακαλύψτε τη συλλογή μας από σκουλαρίκια. Επιλέξτε τα ιδανικά κομμάτια 
                    για να φωτίσετε το πρόσωπό σας και να χαρίσετε λάμψη σε κάθε ώρα της ημέρας.
                </p>
            ...
            {isLoading ? (
                ...
                <div className="text-center py-32 space-y-4 bg-secondary/20 rounded-[2rem] border border-dashed border-border">
                    ...
                    <Link href="/products" className="inline-block text-primary font-body text-sm font-semibold border-b border-primary">
