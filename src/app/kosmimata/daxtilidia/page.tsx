...
export default function DaxtilidiaPage() {
    // Φέρνουμε τα προϊόντα για την κατηγορία Δαχτυλίδια (ID: 17)
    const { data: products = [], isLoading } = useQuery<WooProduct[]>({
        queryKey: ["products", { category: "17" }],
        queryFn: () => getProducts({ per_page: "100", category: "17" }),
    });
    ...
    return (
        <main className="container mx-auto px-4 md:px-8 py-12 md:py-20">
            ...
            <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
                ...
                <ChevronRight className="w-4 h-4" />
                <span className="text-primary font-medium">Δαχτυλίδια</span>
            </nav>
            ...
            <div className="space-y-4 mb-12">
                ...
                <p className="text-muted-foreground font-body max-w-2xl leading-relaxed">
                    Ανακαλύψτε την συλλογή μας από δαχτυλίδια. Βρείτε μοναδικά σχέδια 
                    που θα ολοκληρώσουν και θα αναδείξουν τέλεια την εμφάνισή σας.
                </p>
