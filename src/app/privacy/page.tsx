        ...
        <main className="container mx-auto px-3 sm:px-4 md:px-8 py-6 sm:py-8 md:py-16">
            ...
            <div className="max-w-4xl mx-auto">
                <div className="flex items-center gap-3 mb-4 sm:mb-6">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-primary/10 rounded-2xl flex items-center justify-center">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-8 sm:mb-12">
                    {[
                        ...
                        { icon: UserCheck, label: "Τα Δικαιώματά σας", color: "bg-amber-500" },
                    ].map((item, i) => (
                ...
                <div className="prose prose-sm sm:prose-base max-w-none space-y-6 sm:space-y-8">
                    <section>
                        ...
                        <p className="text-sm sm:text-base leading-relaxed text-muted-foreground">
                            Στο Vaia Charms, σεβόμαστε την ιδιωτικότητά σας και δεσμευόμαστε να προστατεύουμε τα προσωπικά σας δεδομένα.
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside space-y-2 text-sm sm:text-base text-muted-foreground ml-4">
                            <li>Με παρόχους υπηρεσιών που μας βοηθούν να λειτουργήσουμε την επιχείρησή μας (π.χ. εταιρείες αποστολών)</li>
                    ...
                    <section>
                        ...
                        <div className="grid sm:grid-cols-2 gap-3">
                            {[
                                ...
                                <div key={i} className="bg-primary/5 p-3 rounded-lg text-xs sm:text-sm">
                                    ✓ {right}
                                </div>
                            ))}
                        </div>
                    ...
                    <section>
                        <h2 className="font-display text-xl sm:text-2xl font-bold mb-3 sm:mb-4">8. Διατήρηση Δεδομένων</h2>
                        <p className="text-sm sm:text-base leading-relaxed text-muted-foreground">
                            Διατηρούμε τα προσωπικά σας δεδομένα μόνο για όσο χρονικό διάλεσμα είναι απαραίτητο για τους σκοπούς που
                            περιγράφονται σε αυτήν την πολιτική ή όπως απαιτείται από το νόμο.
                        </p>
                    </section>
