...
const newAttributes = [
    {
        name: "Υλικό",
        visible: true,
        options: ["Ορείχαλκος (brass)"]
    },
    {
        name: "Διαστάσεις",
        visible: true,
        options: ["Διάμετρος κρίκου 1 εκ.", "Συνολικό ύψος 2 εκ."]
    }
];

updateProductAttributes(208, newAttributes).then(product => {
    console.log("Product 208 updated successfully!");
