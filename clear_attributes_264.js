...
async function clearProductAttributes(id) {
...
clearProductAttributes(264).then(product => {
    console.log("Product 264: attributes cleared successfully!");
    console.log("Remaining Attributes:", JSON.stringify(product.attributes, null, 2));
}).catch(err => {
