...
async function run() {
    ...
    console.log("Product 186 Attributes:", JSON.stringify(p186?.attributes, null, 2));
    const p197 = await getProduct(197);
    console.log("Product 197 Attributes:", JSON.stringify(p197?.attributes, null, 2));
}
