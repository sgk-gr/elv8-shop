...
const newAttributes = [
    {
        name: "Χρώμα",
        visible: true,
        options: ["Ανοιχτό Πράσινο", "Πέρλα", "Κυπαρισσί"]
    },
    {
        name: "Διαστάσεις",
        visible: true,
        options: ["Συνολικό μήκος 3 εκ."]
    }
];

updateProductAttributes(204, newAttributes).then(product => {
    console.log("Product 204 attributes updated!");
